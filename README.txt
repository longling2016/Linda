As a kind reminder: Please remove the folder /tmp/lwang3/linda before running P2 so that the files created by P1 previously will not affect P2 on that Linux machine :) 


Friendly tips:

1. try the keyboard “Return/Enter” for prompt command will give you more space.

2. tip 1 is always a good idea to check if the current process is finished. Press the keyboard “Return/Enter”, and prompt “linda> ” will show out after the current process is done.
...
The integer showing ahead “->” means the slot number this tuple saved at. It just used for tracking tuples during consistent hashing. The content of tuple is showing after “->”. But this does NOT affect the commands user should enter.
...
3. How if user killed a host while this hosts is waiting for “in” or “rd” command of upcoming tuple?
